...
if (reactNativeMinorVersion >= 59) {
  ...
  upstreamTransformer = require("metro/Components/reactNativeTransformer");
} else if (reactNativeMinorVersion >= 52) {
  upstreamTransformer = require("metro/Components/transformer");
} else if (reactNativeMinorVersion >= 47) {
  upstreamTransformer = require("metro-bundler/Components/transformer");
